 ...
 * @version 2013
 */
public abstract class ListagemDeDependentesPaginada<O, DEPENDENCIA> extends ListagemPaginada<O> {

	protected DEPENDENCIA dependencia;
	
	protected ListagemDeDependentesPaginada( AloMundo aplicacao, Class<? extends Informacao> cadastrador, DEPENDENCIA dependencia, String titulo, String subtitulo, boolean construir ) throws TomaraQueCaiaException {
