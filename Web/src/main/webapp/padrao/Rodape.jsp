...
<span id="larguraVisual" style="visibility:hidden; white-space:nowrap;"></span>
<!-- ------------------------------------------------------------------------------------------------- -->
<div id="cantoDireitoInferior" class="cantoDireitoInferior">
<img src="<%=raiz%>/img/canto_direito_inferior.png" border="0" />
</div>
<!-- ------------------------------------------------------------------------------------------------- -->
<%
String direitosAutorais = tqc.getDireitosAutorais();
if( direitosAutorais != null ){
%>
<div id="direitosAutorais" class="direitosAutorais">
<%=TQCServletUtil.converterParaHTML( direitosAutorais )%>
</div>
<% } %>
<!-- ------------------------------------------------------------------------------------------------- -->
</body>
...
$(document).scrollLeft( <%=rolagemHorizontal%> );
$(document).scrollTop( <%=rolagemVertical%> );
