...
String aceitar = request.getParameter( "aceitar" );
if( aceitar != null && aceitar.equals( "sim" ) ){
	session.setAttribute( "NEGLIGENCIAR.NAVEGADOR", "sim" );
...
$(document).keydown(function(e){
	...
	if( ( kc >= 65 && kc <= 90 ) || ( kc == 13 || kc == 32 || kc == 27 ) ){
		e.preventDefault();
		e.stopPropagation();
		window.location.replace( "Compatibilidade.jsp?aceitar=sim" );
		return false;
	}
});
</script>
...
<a href="Compatibilidade.jsp?aceitar=sim">
<p><img src="<%=raiz%>/img/icone/128/problema.001.png" border="0"></p>
<p class="erroAlerta">Problema de Compatibilidade</p>
<p class="erroMensagem">
A vers&atilde;o do seu navegador n&atilde;o &eacute; compat&iacute;vel com este sistema.<br>
Favor atualizar o seu navegador ou clicar aqui para continuar assim mesmo.
</p>
</a>
</body>
