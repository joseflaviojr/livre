...
public interface Tamanho {
	...
	public long getTamanhoMaximo() throws JoseFlavioException;
	
	/**
	 * {@link #getTamanhoAtual()} <= {@link #getTamanhoMaximo()}
	 */
	public long getTamanhoAtual() throws JoseFlavioException;
