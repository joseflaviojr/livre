...
public interface Selecionador <T extends Objeto> {
	...
	/**
	 * Determina se o {@link Objeto} está adequado aos padrões da seleção.
	 */
	public boolean selecionar( T objeto ) throws DepositoException;
