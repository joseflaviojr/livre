...
/**
 * Arquivo de bytes de sistema hierárquico de armazenamento.
...
public interface Arquivo extends Memoria {
	...
	/**
	 * Nome do arquivo. Ex.: Texto
	 */
	public String getNome() throws DepositoException;
	
	/**
	 * Tipo (extensão) do arquivo. Ex.: txt<br>
	 * Pode ser vazio ou <code>null</code>.
	 */
	public String getTipo() throws DepositoException;
	...
	/**
	 * Apaga definitivamente este {@link Arquivo}, tornando-o inutilizável.
	 * @return <code>false</code>, caso não seja possível apagá-lo.
	 */
