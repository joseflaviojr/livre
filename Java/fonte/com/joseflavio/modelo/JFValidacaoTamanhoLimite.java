...
/**
 * Garante que o tamanho físico visual do conteúdo do atributo não ultrapassará os limites para ele especificados. 
 * @author José Flávio de Souza Dias Júnior
 * @version 2013
 */
@Target({ElementType.FIELD})
@Retention(RetentionPolicy.RUNTIME)
public @interface JFValidacaoTamanhoLimite {
