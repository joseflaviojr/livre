...
/**
 * Visualização de imagem gráfica armazenada em sistema de arquivos.
...
public class Imagem extends SimplesDado implements Identificacao {
	...
	/**
	 * @param url Caminho relativo à raiz da aplicação Web. Ex.: "img/iconep/salvar.png"
	 */
	...
	public Imagem setUrl( String url ) {
		this.url = url;
		return this;
	}
