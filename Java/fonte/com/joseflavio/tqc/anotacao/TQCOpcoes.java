 ...
 * A {@link TQCOpcoes} deve ser anotada em {@link Method método} público, sem parâmetros e que retorne
 * uma {@link List} compatível com as {@link Opcoes} do {@link Dado} {@link #dado() indicado}.
...
public @interface TQCOpcoes {
	...
	/**
	 * {@link Identificacao#getNome() Nome} do {@link Dado} que receberá as {@link Opcoes}.
	 */
	String dado();
