 ...
 * @version 2013
 * @see FormularioCamposTag#getRotulo()
 */
public class FormularioCampoRotuloTag extends TQCTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try{
			...
			FormularioCamposTag tagFormulario = (FormularioCamposTag) tagMae;
			
			JspWriter out = pageContext.getOut();
			out.write( TQCServletUtil.converterParaHTML( tagFormulario.getRotulo() ) );
