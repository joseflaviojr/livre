 ...
 * @version 2013
 */
class ImagemControle implements DadoControle {
	...
	public void imprimir( HttpServletRequest request, TomaraQueCaia tqc, Viagem viagem, Informacao informacao, Dado dado, String id, Writer saida ) throws IOException {
		...
		Imagem imagemDado = (Imagem) dado;
		
		String url = imagemDado.getUrl();
		if( url == null ) return;
		
		saida.write( "<img src=\"" + url + "\" border=\"0\"" );
		
		TomaraQueCaiaDesktopServlet.imprimirEstilo( imagemDado, null, saida );
