 ...
 * @version 2013
 */
class ObjetoControle implements DadoControle {
	...
	public void imprimir( HttpServletRequest request, TomaraQueCaia tqc, Viagem viagem, Informacao informacao, Dado dado, String id, Writer saida ) throws IOException {
		...
		Objeto objetoDado = (Objeto) dado;
		
		String texto = objetoDado.getTexto();
		
		if( texto == null ){
			
			Object objeto = objetoDado.getObjeto();
			
			texto = objeto != null ? objeto.toString() : "";
			
		}

		saida.write( "<span" );
		TomaraQueCaiaDesktopServlet.imprimirEstilo( objetoDado, "dadoTexto", saida );
		saida.write( ">" );
