...
/**
 * Especificação de cabeçalho de {@link Informacao}.
...
public interface Cabecalho {
	...
	/**
	 * Deve {@link Informacao#mais(Dado) compor} o cabeçalho da {@link Informacao}.<br>
	 * Envolver a {@link Informacao#mais(Dado) composição} com os {@link Marcador}es "tqc_cabecalho_i" e "tqc_cabecalho_f", para fins de localização.
	 */
