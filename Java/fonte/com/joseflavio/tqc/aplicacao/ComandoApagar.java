...
public class ComandoApagar extends ComandoImplementado {
	...
	/**
	 * @see AplicacaoTQC_JPA#remover(Object, String, boolean)
	 */
	public ComandoApagar( String rotulo, AplicacaoTQC_JPA aplicacao, Object obj, String msgDependencia, boolean persistirPendencias ) {
		super( rotulo );
		this.aplicacao = aplicacao;
		this.obj = obj;
		this.msgDependencia = msgDependencia;
		this.persistirPendencias = persistirPendencias;
	}
	
	public void acao( Viagem viagem ) throws ValidacaoException, TomaraQueCaiaException {

		aplicacao.remover( obj, msgDependencia, persistirPendencias );
