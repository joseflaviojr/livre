...
/**
 * Gera uma estrutura padronizada de {@link Dado}'s dentro de uma {@link Informacao}.
...
public interface Molde {
	...
	/**
	 * Adiciona os {@link Marcador}es e entre eles os {@link Dado}s resultantes da moldagem.
	 * @param info Destino.
	 */
