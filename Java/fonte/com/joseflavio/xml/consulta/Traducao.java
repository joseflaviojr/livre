...
public class Traducao {
	...
	private Map<String,Valor> valor = new HashMap<String,Valor>();

	public Traducao( String nome ) {
		this.nome = nome;
	}
	...
	public void setValor( Map<String,Valor> valor ) {
		this.valor = valor;
	}
	
	/**
	 * Instância de {@link Traducao}.
	 * @author José Flávio de Souza Dias Júnior
	 * @version 2014
	 */
	public static class Instancia {
		...
		public Instancia( String campo, Traducao tipo ) {
			this.campo = campo;
			this.tipo = tipo;
		}
		...
		public void setTipo( Traducao tipo ) {
			this.tipo = tipo;
		}
