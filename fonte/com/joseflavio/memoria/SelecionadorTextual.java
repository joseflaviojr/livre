...
/**
 * {@link Selecionador} baseado preferencialmente em linguagem textual de pesquisa declarativa (instrução seletiva).<br>
 * Prioridade: {@link #getInstrucao()}<br>
 * Segunda opção: {@link #selecionar(Objeto)}
...
public interface SelecionadorTextual <T extends Objeto> extends Selecionador<T> {
	...
	/**
	 * Instrução textual para seleção de {@link Objeto}s.
	 * @return <code>null</code>, redirecionando a responsabilidade para o método {@link #selecionar(Objeto)}.
	 */
