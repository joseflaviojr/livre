...
/**
 * Espaço em branco medido em caracteres.
...
public class EspacoTextual extends Dado {
	...
	/**
	 * @param quantidade Quantidade de espaços, em caracteres.
	 */
	public EspacoTextual( int quantidade ) {
		this.quantidade = quantidade;
	}

	public Object getConteudo() {
		return new Integer( quantidade );
	}
