...
/**
 * Exceção básica da arquitetura TQC.
...
public class TomaraQueCaiaException extends Exception {
	...
	public TomaraQueCaiaException( Throwable causa ) {
		super( causa );
	}

	public TomaraQueCaiaException( String mensagem ) {
		super( mensagem );
	}
	
	public TomaraQueCaiaException( Throwable causa, String mensagem ) {
