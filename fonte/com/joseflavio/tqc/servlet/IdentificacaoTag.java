...
/**
 * Campo hidden do formulário que identifica a {@link Informacao} em questão.
 * @author José Flávio de Souza Dias Júnior
 * @version 2013
 */
public class IdentificacaoTag extends TQCTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		try{
			...
			IdentificacaoImpressao.imprimir( viagem, info, out );
