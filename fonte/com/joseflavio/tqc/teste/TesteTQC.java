...
public class TesteTQC extends AplicacaoTQC {
	...
	public void inicio( java.util.Map<String, String> parametros ) throws TomaraQueCaiaException {
		novaViagem().visitar( new TesteTQCFormulario( this ) );
		novaViagem().visitar( new Informacao( "Tela vazia" ) {
			public void acao( TomaraQueCaia tqc, Viagem viagem, Comando comando ) throws TomaraQueCaiaException {
			}
			public void antesDeMostrar( TomaraQueCaia tqc, Viagem viagem ) throws TomaraQueCaiaException {
			}
		} );
	}
