...
public class TextoLimite extends Validacao {
	...
	public TextoLimite( String nome, int maxCaracteres, int tipo, String mensagem ) {
		this.nome = nome;
		this.tipo = tipo;
	...
	public TextoLimite( int maxCaracteres, String mensagem ) {
		this( null, maxCaracteres, ValidacaoException.ERRO, mensagem );
	}
	...
	public void validar( Object objeto ) throws ValidacaoException {
		...
		if( objeto.toString().length() > maxCaracteres ) throw new ValidacaoException( nome, tipo, objeto, mensagem );
