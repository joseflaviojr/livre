...
public interface Ordenador <T extends Objeto> extends Comparator<T> {
	...
	/**
	 * Define a ordem de precedência entre dois {@link Objeto}s.
	 * @param a Primeiro {@link Objeto}.
	 * @param b Segundo {@link Objeto}.
	 * @return -1, caso a < b. 0, caso a == b. 1, caso a > b.
	 */
	public int definirOrdem( T a, T b );
