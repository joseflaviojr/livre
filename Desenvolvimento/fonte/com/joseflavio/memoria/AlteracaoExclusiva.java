...
/**
 * Capacidade do objeto de entrar em modo de alteração exclusiva.
...
public interface AlteracaoExclusiva {
	...
	/**
	 * Alguma {@link Thread} está em processo de alteração exclusiva deste objeto?
	 * @see #setAlteracaoExclusiva(boolean)
	 */
	public boolean isAlteracaoExclusiva();
	
	/**
	 * A {@link Thread} corrente está em processo de alteração exclusiva deste objeto?
	 * @see #setAlteracaoExclusiva(boolean)
	 */
	public boolean estouComAlteracaoExclusiva();
	
	/**
	 * Determina que este objeto deverá entrar o mais breve possível em modo de alteração exclusiva, isto é, alterações e remoções de dados internos poderão ser realizadas apenas pela {@link Thread} corrente.<br>
	 ...
	 * Uma subsequente chamada positiva a outra chamada positiva entrará em modo de espera pela negação da primeira chamada.
