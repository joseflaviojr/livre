...
/**
 * Especificação de {@link Comando}s principais.
...
public interface ComandoPrincipal {
	...
	/**
	 * Deve executar {@link Informacao#mais(Comando)} para cada {@link Comando} principal.<br>
	 * O grupo de {@link Comando}s deverá ser envolvido pelos {@link Marcador}es "tqc_comandos_i" e "tqc_comandos_f", para fins de localização.
	 */
