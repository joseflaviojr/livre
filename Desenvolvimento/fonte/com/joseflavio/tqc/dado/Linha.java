...
/**
 * Linha de {@link Dado}'s.<br>
 * Uma instância de {@link Linha} indica o início de sua construção, a qual é finalizada por uma {@link LinhaFim}.
 * @author José Flávio de Souza Dias Júnior
 * @version 2013
 */
public class Linha extends SimplesDado {
	
	public Linha() {
	}
	
	public Linha( String estilo ) {
		super( estilo );
	}
