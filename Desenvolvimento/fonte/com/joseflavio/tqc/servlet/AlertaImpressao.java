 ...
 */
class AlertaImpressao implements Impressao {

	public static void imprimir( Alerta alerta, Writer saida ) throws IOException {
		
		if( alerta != null ){
		
			saida.write( "<script language=\"JavaScript\">\n" );
			saida.write( "alert( '" + alerta.getMensagem() + "' );\n" );
			saida.write( "</script>\n" );
	...
	public void imprimir( HttpServletRequest request, TomaraQueCaia tqc, Viagem viagem, Informacao informacao, Writer saida ) throws IOException {
		...
		imprimir( viagem.removerAlerta(), saida );
